...
if __name__ == "__main__":
    ...
    log_prob_knn = (
        StateSpaceHybrid().fit((ztrain, xtrain)).score((ztest, xtest))
    )
    ...
    log_prob_knn = (m := StateSpaceHybrid().fit((ztrain, xtrain))).score(
        (ztest, xtest)
    )
    ...
    log_prob_knn_pickled = (
        StateSpaceHybrid().from_pickle(p).score((ztest, xtest))
    )
